...
/**
 * CakeDatabaseThemesTemplatesFixture
 */
class CakeDatabaseThemesTemplatesFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'value' => ['type' => 'text', 'length' => 4294967295, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null],
        ...
        '_constraints' => [
            ...
            'name' => ['type' => 'unique', 'columns' => ['name', 'theme_id', 'deleted'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'created' => '2020-06-09 11:14:27',
                'created_by' => 1,
                'modified' => '2020-06-09 11:14:27',
                'modified_by' => 1,
                'deleted' => '2020-06-09 11:14:27',
                'deleted_by' => 1,
            ],
        ];
        parent::init();
